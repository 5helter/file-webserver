...
namespace idc
{
    class cftpclient
    {
        ...
        public:
            ...
            bool m_connctfailed;    //如果网络连接失败
            bool m_loginfailed;     //如果登录失败，用户名
            bool m_optionfailed;    //如果设置传输模式失败
            ...
            void inidata();         // 初始化m_size和m_mtime成员变量。
            ...
            bool mtime(const string& remotefilname);
