...
ctcpserver tcpserver;     //tcpserver对象
...
int main(int argc,char* argv[])
{
    if(argc!=3)
    {
      ...
      printf("Example:./tcpfileserver 5005 /myproject/fileserver.log\n"); 
      printf("         /myproject/tools/bin/procctl 10 /myproject/tools/bin/fileserver 5005 /log/idc/fileserver.log\n\n\n"); 
      return -1;
    }
    //关闭所有信号，避免产生僵尸进程
