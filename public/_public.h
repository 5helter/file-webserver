...
public:
    ...
    bool read(string &buffer,const int itimeout=0);                           // 接收文本数据。文本数据需要处理粘包和分包的问题，保证把每一次报文完成独到不残留
    ...
    bool write(const string &buffer);                          // 发送文本数据。文本数据需要处理粘包和分包的问题，保证把每一次报文完成独到不残留
